...
function shift(letter, amount) {
    ...
    else if (index > alphabets[chosen_language].chars.length - 1) index = index - alphabets[chosen_language].chars.length;
...
function get_coolness(string) {
    ...
    for (let i = 1; i < string.length - 1; i++) {
        if (string[i] == " " && alphabets[chosen_language].vowels.indexOf(string[i - 1]) == -1) coolness += 1;
        if (string[i] == " " && alphabets[chosen_language].vowels.indexOf(string[i + 1]) == -1) coolness += 1;
        if (string[i] == " " && alphabets[chosen_language].vowels.indexOf(string[i + 1]) !== -1 && alphabets[chosen_language].vowels.indexOf(string[i - 1]) !== -1) coolness += 3;
